...
send_telegram_message "Running Python scripts Masuk..."
cd /var/www/nc-gym && python test.py
send_telegram_message "Running Python scripts Keluar..."
cd /var/www/nc-gym && python test2.py
sleep 10
